...
public class GameManager : MonoBehaviour
{
    ...
    public void SpawnRemotePlayers()
    {
        ...
        {
            mapController.SpawnRemotePlayer(peer.ClientRoomId, peer.Username, peer.Color);
        }
    }
    ...
    public void RemovePlayer(int _clientRoomId)
    {
        if (mapController != null && mapController.isRunning)
        {
            ...
            {
                mapController.PlayerLeft(_clientRoomId);
            });
        }
    }

    public void PlayerMovement(int _clientRoomId, int _tick, Vector3 _position, Quaternion _rotation, bool _ragdoll, int _animation)
    {
        if (mapController.players.TryGetValue(_clientRoomId, out RemotePlayerManager _player))
        {
    ...
    public void PlayerGrab(int _grabber, int _grabbed)
    {
        ...
        if (_grabbed == ClientInfo.instance.ClientRoomId)
    ...
    public void PlayerPush(int _pusher, int _pushed)
    {
        ...
        if(_pushed == ClientInfo.instance.ClientRoomId)
        {
