...
public class MapController : MonoBehaviour
{
    ...
    public void SpawnLocalPlayer()
    {
        ...
        p.transform.GetChild(0).GetChild(1).GetComponent<MeshRenderer>().material = PlayerColor.instance.materials[ClientInfo.instance.Color];
    ...
    public void SpawnRemotePlayer(Guid _id, string _username, int _color)
    {
        ...
        p.transform.GetChild(0).GetChild(1).GetComponent<MeshRenderer>().material = PlayerColor.instance.materials[_color];
