...
public class MenuSceneManager : MonoBehaviour
{
    ...
    {
        menuPlayer.transform.GetChild(1).GetComponent<MeshRenderer>().material = PlayerColor.instance.materials[ClientInfo.instance.Color];
        lookingPlayer.transform.GetChild(1).GetComponent<MeshRenderer>().material = PlayerColor.instance.materials[ClientInfo.instance.Color];
    }
}
